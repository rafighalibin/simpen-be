...
public class SimpenBackendApplication {
	...
	@Bean
	@Transactional
	CommandLineRunner run(UserService userService, KelasService kelasService, JenisKelasService jenisKelasService,
		...
		return args -> {
			...
			// "Akademik");
			// // Operasional
			// UserModel operasional = userService.addUser("operasional@kalananti.id",
			// "operasional", "Operasional");
			// // Pengajar
			// UserModel pengajar = userService.addUser("pengajar@kalananti.id", "pengajar",
			// "Pengajar");
			// Jenis Kelas
